...
func_def            : def IDENTIFIER ( typed_var_list ) return_type : NEWLINE INDENT func_body DEDENT
return_type         : -> type | epsilon
typed_var_list      : typed_var typed_var_list_cont | epsilon
typed_var           : IDENTIFIER : type
type                : IDENTIFIER | IDSTRING | [ type ]
...
class_def           : class IDENTIFIER ( IDENTIFIER ) : NEWLINE INDENT class_body DEDENT
...
cexpr               : IDENTIFIER | literal | [ expr_list ] | ( expr ) | member_expr | index_expr | member_expr ( expr_list ) | IDENTIFIER ( expr_list ) | cexpr bin_op cexpr
expr_list           : expr expr_list_cont | epsilon
expr_list_cont      : , expr expr_list_cont | epsilon
member_expr         : member_expr . IDENTIFIER
...
target              : IDENTIFIER | member_expr | index_expr
